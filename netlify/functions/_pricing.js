...
const CATALOG = {
  ...
  'website-business': {
    service: 'Website', bundle: 'Business', total: 850, timeline: '~2 weeks',
    summary: 'A multi-page site for a business that needs to convert visitors.',
    features: [
  ...
  'website-advanced': {
    service: 'Website', bundle: 'Advanced', total: 1900, timeline: '~4 weeks',
    summary: 'A site with a backend — payments, logins, dashboards, real logic.',
    features: [
      'Everything in Business',
      'Unlimited pages',
      'Backend / serverless functions',
      'Stripe payment integration (like this very site)',
